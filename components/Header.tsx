...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 bg-forge-black/95 backdrop-blur supports-[backdrop-filter]:bg-forge-black/80 shadow-[0_12px_14px_rgba(0,0,0,0.2)]">
      <div className="mx-auto flex max-w-[1440px] items-center justify-between gap-8 px-6 py-6 md:px-12">
        ...
        {/* Mobile menu trigger — expand into a drawer with the same links */}
        <MobileNav />
      </div>
    </header>
  );
...
function MobileNav() {
  return (
    <details className="relative md:hidden">
      <summary
        className="flex cursor-pointer list-none items-center justify-center rounded-md p-2 text-pure-white"
